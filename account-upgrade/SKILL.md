...
description: 账号升级与权限说明 skill。用于处理配额不足、绑定账号、Pioneer 权限、PDF 不可用、升级方案和 API Key 入口说明。当用户说“怎么升级”“为什么不能导出 PDF”“绑定账号”时使用。
---
...
- “你现在是 Guest，PDF 不开放，先完成账号升级，再回来导出”
- “你已经用完免费改写次数，建议先整理目标岗位，再集中做一次定向改写”
